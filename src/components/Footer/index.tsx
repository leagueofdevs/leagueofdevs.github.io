...
function Footer() {
  const footerNavigation = {
    social: [
      ...
      {
        name: "WhatsApp",
        href: "https://chat.whatsapp.com/HeNZbbvXudP17nZZDXUzAp",
        icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
          <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        <div className="border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <div className="flex flex-col">
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
              Esta competição não é afiliada/patrocinada pela Riot Games, Inc.
              ou League of Legends/Teamfight Tactics Esports.
            </p>
            <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-4">
              &copy; 2026 Copa Recife de League of Legends. Todos os direitos
              reservados.
            </p>
          </div>
        </div>
