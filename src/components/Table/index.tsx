...
function Table({ items }: TableProps) {
  ...
  return (
    <div className="flex flex-col gap-y-6">
      ...
      {items.length === 0 ? (
        <div className="bg-gray-800/50 p-8 rounded-lg text-center border border-gray-700 border-dashed">
            <p className="text-xl font-semibold text-gray-200">O campeonato começará em breve</p>
            <p className="mt-2 text-gray-400">Acompanhe as inscrições na página inicial.</p>
        </div>
      ) : (
